...
export interface Contact {
  ...
  account_id: string;
  /**
   * Puede ser null: desde que Meta habilito los nombres de usuario en
   * WhatsApp, un contacto puede llegar sin numero (migracion 041).
   */
  phone: string | null;
  ...
  /**
   * `contacts[].wa_id` de Meta: la identidad numerica sin prefijo. Es la
   * llave con la que llegan los avisos de estado. Migracion 041.
   */
  whatsapp_id?: string | null;
  /**
   * `contacts[].user_id` de Meta: el nombre de usuario con prefijo de pais
   * (ej. CO.1777593217005660). Es la direccion de respuesta preferida
   * cuando el contacto no tiene telefono. Migracion 043.
   */
