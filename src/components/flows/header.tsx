  ...
  return (
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        {dirty && (
          <span
            ...
            title="Cambios sin guardar: pulsa Guardar para conservarlos"
            aria-live="polite"
          >
        ...
        <div className="ml-auto flex flex-wrap items-center gap-1.5">
          ...
          {state.status === 'active' ? (
            ...
            <Button
              ...
              title={
                !canActivate
                  ? 'Corrige los problemas de abajo antes de activarlo'
                  : undefined
              }
            >
              {activating ? (
      ...
      <input
        ...
        placeholder="Agrega una descripción breve (interna: los clientes no la ven)"
