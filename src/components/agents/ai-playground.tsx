    ...
    try {
      ...
      if (!res.ok) {
        if (data.code === 'ai_not_configured') {
          toast.error(
            'Aún no hay un agente configurado. Primero completa la configuración.'
          );
        } else {
        ...
        {turns.length === 0 && (
          <div className="text-muted-foreground flex h-full flex-col items-center justify-center text-center text-sm">
            ...
            <p className="mt-1 text-xs">
              ...
              respuesta automática, incluida la transferencia a un humano.
            </p>
            {onGoToSetup && (
              <Button
                variant="link"
              ...
              >
                ¿Aún no lo configuras? Ir a Configuración{' '}
